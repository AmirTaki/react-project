...
const ImageAdvert = () => {
    return(
        <div className="w-[100%] h-[500px] bg-blue-500 flex   flex-col flex-wrap overflow-scroll">
            ...
            <div className="bg-gray-500 h-[500px] w-[50%] "></div>
            <div className="bg-amber-500 h-[500px] w-[50%] "></div>
