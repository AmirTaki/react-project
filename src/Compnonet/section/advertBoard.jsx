const AdvertBoard = () => {
    return(
        <>
            <div className="bg-black w-[100%]  text-gray-300 flex flex-col p-10 gap-5 ">
                <div className=" bg-red-300 text-3xl text-center">
                    <h1 className="">Sneakers, Activewear and Sporting Goods</h1>
                </div>

                <div className="bg-orange-400 w-[80%] mx-auto">
