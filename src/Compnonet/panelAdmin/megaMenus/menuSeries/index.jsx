...
const MegaMenuSeriesPanelAdmin = () => {
    ...
    const deleteItem = async (id) => {
        try{
            await api.delete(`tables/megaMenu/menuSeries/delete.php/${id}/delete`).then((res) => {
                res;
                getSeriesMegaMenu();
            })
        }
        ...
        <div className="">
            ...
            <div className=" top-20 absolute w-full  min-h-screen bg-[#252525]!  text-white z-10">
                <div className="flex flex-col items-center justify-around ">
                    ...
                    <Link to = "/panelAdmin/megaMenu/AddSeries">
                        <button className="mt-10 border-0 flex items-center justify-center text-green-500  text-lg hover:tracking-[.2rem] duration-200">create series</button>
                    </Link>
