...
const MenuFooterPanelAdmin = () => {
    const [menus, setMenus] =  useState([]);
   
    const getMenuFooterRequest = async () => {
        try{
    ...
    useEffect(() => {getMenuFooterRequest()}, [])


    const changeStatus = async (id) => {
        try {
            await api.get(`tables/footer/menuFooter/status.php/${id}/changeStatus`, {withCredentials: true}).then((res) => {
                res;
    ...
    return(
        <>
            ...
            <div className="flex flex-col items-center justify-around ">
                ...
                <h1 className="text-center my-5 text-3xl hover:tracking-[.3rem] duration-200"> menu footer table</h1> 
            </div>
                        ...
                        return(
                            <tr key = {ind}>
                                ...
                                <th className="flex justify-center items-center gap-7! max-md:flex-col max-md:gap-1!" >
                                    ...
                                    <Link to = {`/panelAdmin/footer/EditMenuWhiteBoard/${item.id}/edit`}>
...
export default MenuFooterPanelAdmin;