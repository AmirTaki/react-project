...
const BoardBlackPanelAdmin = () => {
    const [board, setBoard] =  useState([]);
   
    const getBoardRequest = async () => {
        try{
    ...
    const deleteItem = async (id) => {
        try {
            await api.delete(`tables/footer/boardBlack/delete.php/${id}/delete`).then((res) => {
                res.data;
                getBoardRequest();
            })
        }  
    ...
    return(
        <>
            ...
            <div className="flex flex-col items-center justify-around ">
                ...
                <h1 className="text-center my-5 text-3xl hover:tracking-[.3rem] duration-200"> board black table</h1> 
            </div>
...
export default BoardBlackPanelAdmin;