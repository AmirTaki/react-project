...
const EditFooterBoardBlack = () => {
    ...
    const getRequestBoard =  async (id) => {
        try{
            await api.get(`tables/footer/boardBlack/board.php/${id}` ,{withCredentials: true}).then((res) => {
    ...
    const editItems = async (event, id) => {
        ...
        try{
            await api.put(`tables/footer/boardBlack/edit.php/${id}`, state).then((res) => {
                res.data;
                navigate('/panelAdmin/footer/boardBlack')
            })
        }
...
export default EditFooterBoardBlack;