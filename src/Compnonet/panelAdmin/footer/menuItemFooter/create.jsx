...
const CreateFooterMenuItems = () => {
    ...
    const addItem = async (event) => {
        ...
        try{
            await api.post('tables/footer/menuItemFooter/add.php', state, {withCredentials: true}).then((res) => {
                res;
...
export default CreateFooterMenuItems;