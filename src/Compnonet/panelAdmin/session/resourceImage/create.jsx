...
const CreateSessionResourceImage = () => {
    ...
    const AddResource = async (event) => {
        ...
        try{
            await api.post('tables/session/resourceImage/add.php', formData, {withCredentials: true}, {
                headers: {
            ...
            if(err.message == 'Request failed with status code 422'){
                dispatch({type: 'warning', payload : {title: 'title is requierd!', image: "image is requierd", body: 'body is requierd', }})
            }
        ...
        <div className="">
            ...
            <div className=" top-20 absolute w-full  min-h-screen bg-[#252525]!  text-white z-10">
                <div className="flex flex-col justify-center items-center">
                    <h1 className="text-4xl my-5 hover:tracking-[.4rem] duration-200 ">ADD RESOURCE</h1>
                    <form>
                        {/*image view  */}
...
export default CreateSessionResourceImage;