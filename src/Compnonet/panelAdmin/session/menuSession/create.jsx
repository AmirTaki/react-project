...
const CreateSessionMenu = () => {
    ...
    const addMenus = async (event) => {
        event.preventDefault();

        dispatch({type: 'warning', payload: ''})

        try{
            await api.post("tables/session/sessionMenu/add.php", state, {withCredentials: true}).then((res) => {
                res;
