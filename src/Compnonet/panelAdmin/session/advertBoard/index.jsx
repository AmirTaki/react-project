...
const AdvertBoardPanelAdmin = () => {
    const [advertImage, setAdvertImage] = useState([])
    const requestAdvertBoard = async () => {
        try{
        ...
        <>
            ...
            <div className=" top-20 absolute w-full  min-h-screen bg-[#252525]!  text-white z-10">
                <div className="flex flex-col items-center justify-around ">
                    ...
                    <h1 className="text-center my-5 text-3xl hover:tracking-[.3rem] duration-200"> advert board table</h1> 
                </div>
...
export default AdvertBoardPanelAdmin;