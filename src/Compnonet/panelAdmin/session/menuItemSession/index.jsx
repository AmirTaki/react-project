...
const MenuItemSessionPanelAdmin = () => {
    const [items, setItmes] = useState([]);
    const requestMenuItems = async () => {
        try{
            await api.get('tables/session/menuItemSession/items.php', {withCredentials: true}).then((res) => {
...
export default MenuItemSessionPanelAdmin;